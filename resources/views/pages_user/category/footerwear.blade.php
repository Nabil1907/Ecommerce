...
<!--===============================================================================================-->
   ...
   $.ajax({
   url:"{{ route('live_search.action_category') }}",
   method:'GET',
   ...
   error: function(data){
    ...
    $.ajax({
   url:"{{route('search_product.search_category')}}",
   method:'GET',
   ...
   error: function(data){
    ...
    var color = "cyan" ; 
    $.ajax({
    url:"{{route('search_product_color.search_color_category')}}",
    method:'GET',
